    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="space-y-8 text-gray-300">
        ...
        <section>
          ...
          <p>
            This Website is operated for educational purposes and made available to a global audience. Users are
            responsible for ensuring their use of the Website complies with the laws applicable to them. Where
            mandatory consumer protection laws of your country of residence apply, nothing in these Terms limits
            those rights.
          </p>
        </section>

        <div className="text-center text-gray-500 text-sm pt-8 border-t border-gray-800">
          <p>&copy; {year} NotSoDeFi.com - Educational Analysis - Not Financial Advice</p>
        </div>
      </div>
    </div>
  );
