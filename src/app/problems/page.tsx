      ...
      <section className="mb-10">
        ...
        <div className="space-y-4 text-white/80">
          <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
            <h4 className="font-semibold text-red-400 mb-2">Problem</h4>
            <p className="text-sm">
              Liquid staking protocols concentrate stake. The largest liquid staking protocol on Ethereum
              accounts for roughly 30% of staked ETH. Users delegate for convenience, creating new
              centralization vectors in PoS systems.
            </p>
          </div>
          <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
            <h4 className="font-semibold text-green-400 mb-2">Possible Approach</h4>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4 text-white/80">
          <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
            <h4 className="font-semibold text-red-400 mb-2">Problem</h4>
            <p className="text-sm">
              Smart contracts need external data. A handful of oracle networks dominate this
              infrastructure across DeFi. Oracle failure = DeFi failure. Provider concentration
        ...
        <div className="space-y-4 text-white/80">
          <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
            ...
            <p className="text-sm">
              ...
              Overcollateralized stablecoins are often partly backed by centralized stablecoins &mdash;
              an issuer freeze on that collateral can destabilize the whole system.
          ...
          <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
            <h4 className="font-semibold text-green-400 mb-2">Possible Approach</h4>
            <p className="text-sm">
              Native collateral only, not centralized stablecoins. Diversified collateral baskets.
