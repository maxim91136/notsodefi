        ...
        <div className="space-y-4 text-white/80">
          ...
          <div className="space-y-6 mt-6">
            ...
            <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
              <h3 className="text-lg font-semibold text-blue-400 mb-3">Chain Score (A1-A5)</h3>
              <p className="text-sm text-white/60 mb-3">
                Network metrics fetched daily via chain-specific APIs.
              </p>
              <ul className="list-disc list-inside space-y-1 text-sm">
                <li><strong>A1</strong> - Nakamoto Coefficient</li>
                <li><strong>A2</strong> - Validator/Miner Concentration</li>
                <li><strong>A3</strong> - Client Independence</li>
                <li><strong>A4</strong> - Node Geography &amp; Hosting</li>
                <li><strong>A5</strong> - Full Node Decentralization</li>
              </ul>
            </div>
