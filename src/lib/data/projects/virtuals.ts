 ...
 *
 * HONESTY CHECK: No "fair launch" claims. Transparent about VC backing.
 */
...
const rawValues: Record<string, number | null> = {
  // Chain Score (A1-A4) - Adapted for DeFi/Protocol
...
export const virtuals: Project = {
  ...
  description:
    'AI Agent launchpad on Base. Formerly PathDAO (2021). VC-backed ($16M seed). No false decentralization claims.',
