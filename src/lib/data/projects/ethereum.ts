...
const rawValues: Record<string, number | null> = {
  // Chain Score (A1-A5)
  A1: 2,    // Nakamoto Coefficient ~2 (largest liquid staking protocol + largest exchange dominate staking)
  ...
  // Control Score (B1-B6)
  B1: 4,    // Ethereum Foundation has notable soft influence: treasury, roadmap input, grants
  /**
   ...
   * - Ethereum Foundation funds most client teams (indirect influence)
   ...
   */
  B2: 5,
  B3: 6,    // Ethereum Foundation maintains ethereum.org but many independent frontends exist
