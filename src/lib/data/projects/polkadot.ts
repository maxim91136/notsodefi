 ...
 *    A single major exchange runs 15+ validators controlling ~37% of staked DOT.
 *
 * 2. EXCHANGE CONCENTRATION
 *    Top 15 validators are ALL run by one exchange (Jan 2025 Subscan data).
 ...
 *    Parity Technologies has substantial influence over core development.
...
const rawValues: Record<string, number | null> = {
   ...
   * - A single major exchange runs 15+ validators = ~37% of staked DOT
   ...
   *
   * Parity Technologies' Rust implementation remains the dominant client.
   ...
   *
   * Web3 Foundation and Parity Technologies have significant influence over decisions.
   ...
   * - Community contributions exist but Parity retains significant influence over direction
   * - Alternative client teams have limited influence on core protocol
   *
   ...
   * - polkadot.com, polkadot.network maintained by W3F
   ...
   * - Exchange wallets concentrate retail stake
...
export const polkadot: Project = {
  ...
  notes: [
    'Polkadot markets a high Nakamoto Coefficient (149-173), but this counts individual validators, not operators. A single major exchange alone runs 15+ validators controlling ~37% of stake.',
