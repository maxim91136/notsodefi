...
export interface ProjectConfig {
  ...
  kvKey: string;     // KV storage key (e.g., 'bitcoin', 'bitcoincash')
...
export const PROJECTS: ProjectConfig[] = [
  ...
  { id: 'cardano', kvKey: 'ada', symbol: 'ADA' },
  { id: 'dogecoin', kvKey: 'dogecoin', symbol: 'DOGE' },
  { id: 'avalanche', kvKey: 'avax', symbol: 'AVAX' },
  { id: 'tron', kvKey: 'trx', symbol: 'TRX' },
  ...
  { id: 'bittensor', kvKey: 'tao', symbol: 'TAO' },
 ...
 * Helper functions
 */
export function getKvKey(projectId: string): string {
  return PROJECT_ID_TO_KV_KEY[projectId] || projectId;
}
